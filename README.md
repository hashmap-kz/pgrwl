...
- [🚀 About](#-about)
- [🛠️ Usage](#🛠️-usage)
  - [Receive Mode](#receive-mode-the-main-loop-of-the-wal-receiver)
  - [Serve Mode](#serve-mode-used-during-restore-to-serve-archived-wal-files-from-storage)
...
retention:                               # Optional (used in receive mode)
